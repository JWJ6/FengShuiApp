...
const PRICING = {
  fengshui: { cents: 1990, name: 'Full Feng Shui Report', description: 'Unlock all areas, detailed solutions, and general tips', path: 'report' },
  palm_reading: { cents: 1990, name: 'Full Palm Reading', description: 'Unlock all life areas, detailed insights, and personalized guidance', path: 'palm-reading/report' },
};
